...
namespace SFB.Web.ApplicationCore.Services.DataAccess
{
    public interface ISelfAssesmentDashboardDataService
    {
        ...
        Task<List<SADSchoolRatingsDataObject>> GetSADSchoolRatingsDataObjectAsync(string assesmentArea, EstablishmentType financialType, string overallPhase, bool hasSixthForm, string londonWeighting, string size, string FSM, decimal score, string term);
