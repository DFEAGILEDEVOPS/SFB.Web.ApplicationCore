...
{
    public class OLD_EfficiencyMetricNeighbourModel
    {
        private OLD_EfficiencyMetricDataObject EMData { get; set; }
        private EdubaseDataObject ContextData { get; set; }

        public OLD_EfficiencyMetricNeighbourModel(int urn, int rank, EdubaseDataObject contextData, OLD_EfficiencyMetricDataObject efficiencyMetricData)
        {
            Urn = urn;
            Rank = rank;
